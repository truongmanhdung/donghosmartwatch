...
<body>
  ...
  <div class="login">
    <div class="login_header row">
      <p class="dn col-6 login_hover">
        Đăng nhập
        <span class="span1 hover_span"></span>
      </p>
      <p class="dk col-6 login_hover">
        Đăng kí
        <span class="span2"></span>
      </p>
    </div>
    <div class="dangnhap login_hien col-xs-4 col-4 col-sm-4 col-md-4 col-lg-4">
      <form action="" method="post">
          <div class="mb-3">
            <label for="exampleInputEmail1" style="color: white; font-weight: bold;" class="form-label">Email</label>
            <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" style="color: white; font-weight: bold;" class="form-label">Password</label>
            <input type="password" name="password" class="form-control" id="exampleInputPassword1">
          </div>
          <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="exampleCheck1">
            <label class="form-check-label" style="color: white; font-weight: bold;" for="exampleCheck1">Lưu mật khẩu</label>
          </div>
          <button type="submit" style="color: white; border: 1px solid white; font-weight: bold;" name="submit_dn" class="btn btn_login btn-primary">Đăng nhập</button>
      </form>
      <?php
        if (isset($_POST['submit_dn'])) {
          ...
          $result2 = $conn->query("SELECT * FROM usermember where email = '" . $_POST["email"] . "'");
          if($result2->num_rows > 0){
            while($row = $result2->fetch_assoc()){
              $pass1 = $row['password'];
              $email1 = $row['email'];
              if ($pass1 == $pass) {
                header('Location: quanli/material-dashboard-dark-edition-v2.1.0/examples/dashboard.php');
              }
            }
    ...
    <div class="dangki col-xs-4 col-4 col-sm-4 col-md-4 col-lg-4">
      <form action="" method="post">
          <div class="mb-3">
            <label for="exampleInputName1" style="color: white; font-weight: bold;" class="form-label">Name</label>
          ...
          <button type="submit" name="submit_dk" style="color: white; border: 1px solid white;font-weight: bold;" class="btn_login btn btn-primary">Đăng kí</button>
      </form>
    <?php
    ...
    if (isset($_POST['submit_dk'])) {
				  ...
				  $conn = new mysqli('localhost','root','','donghosmartwatch');
					...
					if ($result->num_rows > 0) //kiểm tra số dòng
					{
					    ...
					    $sql = "INSERT INTO member VALUES ('','$email','$name','$password','')";
						$b = $conn->query($sql);
								if($b){
        ...
        <div class="row header-content_list">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 header-content-item">
            ...
            <p class="header-content_text" style="z-index: 10000000000000;">
              ...
              Bạn hãy đăng nhập hoặc đăng kí tài khoản thành viên để nhận ưu đãi bất ngờ từ Smart Watch.
            </p>
            <p class="header-content_text" style="z-index: 10000000000000;">Chào mừng bạn đến với chuỗi cửa hàng đồng hồ của Smart Watch</p>
          </div>
        </div>
      </div>
      <!-- end header-content -->
